  ...
  return (
    <>
      ...
      <div className="bg-white py-16">
        ...
        <div data-aos='fade-up' className="heading mb-32 xl:ml-[280px] lg:ml-[50px] ml-[50px]">
          <h1 className='text-[#e65f78] mt-[30px] '>BIOGRAPHY</h1>
          <span className="about_txt ">
            <h1 className='text-[30px] font-bold text-[#6f6f6f] mt-5'>About Me</h1>
          </span>
        </div>
        <div className="item lg:flex">
          ...
          {/* ------------------right_side----------- */}
          <div data-aos='fade-up' className="sm:pl-[100px] pl-5 lg:mt-0 mt-16 ">
            ...
            <p data-aos='fade-up' className="pt-[45px] text-justify xl:pr-[350px] sm:pr-20 pr-5  text-[16px] text-[#6f6f6f]">It's Sahil, Professional Web Developer. I love to write code, it's my passion. I am here to help you, i am here to design your web page. i can help you to describe yourself in the best way.
              No matter how difficult your web page is, i will find an easy way and complete your work anyway. Stay connected with me............😊</p>

            <div data-aos='fade-up' className="flex pt-10 sm:pr-10  text-[#6f6f6f]">
            ...
            <div className="downloads flex space-x-5">
              <a href={certificate} download="certificate" target='_blank'>
                <button data-aos='fade-up' className="bg-[#e65f78] text-white mt-5 h-[60px]  px-[12px]">Download Certificate</button>
              </a>

              <a href={cv} download="Sahil ALi -resume" target='_blank'>
                <button data-aos='fade-up' className="bg-[#e65f78] text-white mt-5 h-[60px]  px-[12px]">Download Resume</button>
              </a>
